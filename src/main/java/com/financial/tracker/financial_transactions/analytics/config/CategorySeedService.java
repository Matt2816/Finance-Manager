...
@Component
@Order(1)
public class CategorySeedService implements ApplicationRunner {
    ...
    void seedFromYaml() throws Exception {
        ...
        try (BufferedReader reader = new BufferedReader(
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (trimmed.startsWith("rules:")) {
                    flushRule(currentPattern, currentCategory, currentPriority, slugToId);
        ...
        log.info("Seeded {} categories and {} merchant rules", slugToId.size(), ruleRepository.count());
    }

    private void flushRule(String pattern, String categorySlug, int priority, Map<String, Long> slugToId) {
